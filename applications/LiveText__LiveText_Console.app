...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>LiveText__LiveText_Panel</components>
        </componentList>
    ...
    <description>LiveMessage is the conversational messaging solution for Salesforce that enables consumers to connect with your business using their preferred messaging app. LiveMessage reduces call volume, increases agent productivity and improves customer satisfaction.</description>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>LiveMessage</label>
    <logo>LiveText__HeyWire/LiveText__LiveText_Console_App_Logo.png</logo>
    <preferences>
